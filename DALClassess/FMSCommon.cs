...
namespace IOM.IECFMS.DAL
{
    ...
    public class FMSCommon
    {
        ...
        public static RecentLogType getRecentLogType(int nItem)
        {
            ...
            {
                case 0:
                    return RecentLogType.tblAsset;
                case 1:
                    return RecentLogType.tbl_Invoice;
                case 2:
                    return RecentLogType.tbl_AssetTrans_Detail;
                case 3:
                    return RecentLogType.tblUser;
                case 4:
                    return RecentLogType.tblBlueBoxPacking;
                case 5:
                    return RecentLogType.tblUserAlocation;
                default:
                    return RecentLogType.tbl_AssetTrans_Detail;//to be changed
        ...
        public static string GetNavigateURL(string Id, string sURL)
        {
            if (Id != null || Id != "")
            {
                return (sURL + FMSCommon.EncryptQueryString(Id));
            }
            else
            {
                return "#";
